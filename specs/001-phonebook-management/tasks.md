...
- [X] T129 With both hosts running, do the in-browser Swagger UI walkthrough at `https://localhost:7001/swagger`: Authorize as `phonebook-swagger`, then call POST and GET. Tick the remaining item in the README quickstart checklist, per T124 / FR-015 / SC-001 (partial)
